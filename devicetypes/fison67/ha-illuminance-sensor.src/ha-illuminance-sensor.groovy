...
metadata {
	definition (name: "HA Illuminance Sensor", namespace: "fison67", author: "fison67") {
	...
	tiles {
		multiAttributeTile(name:"illuminance", type:"generic", width:6, height:4) {
            tileAttribute("device.illuminance", key: "PRIMARY_CONTROL") {
                attributeState("illuminance", label:'${currentValue}lx',
                    backgroundColors:[
...
def setStatus(String value){
    ...
    sendEvent(name: "illuminance", value: value as double)
